import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-Ct2VqHzk.js";import{n as te,t as n}from"./fogFragment-EikOP4pH.js";import{t as r}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as i}from"./meshUboDeclaration-BATNZvmb.js";import{a,c as ne,i as re,l as ie,n as ae,o as oe,r as se,s as ce,t as le}from"./oitFragment-CKv-hLSp.js";import{t as ue}from"./mainUVVaryingDeclaration-B_7d0nc3.js";import{t as de}from"./helperFunctions-BH8P-eyq.js";import{n as fe,t as pe}from"./reflectionFunction-Cd8WyD5Q.js";import{n as me,t as he}from"./imageProcessingFunctions-DS1LMf3p.js";import{n as ge,r as _e,t as ve}from"./bumpFragment-CZy0KIWh.js";import{t as ye}from"./logDepthDeclaration-DYYUVTrx.js";import{n as be,t as xe}from"./lightFragment-dEiSF_dQ.js";import{t as Se}from"./logDepthFragment-CxtJswLx.js";import{n as Ce,t as we}from"./pbrIBLFunctions-b8fwQKtH.js";import{t as Te}from"./pbrBRDFFunctions-DxfbxN23.js";import{t as Ee}from"./harmonicsFunctions-CMr56qfT.js";import{a as De,c as Oe,d as ke,f as Ae,i as je,l as Me,n as Ne,o as Pe,r as Fe,s as Ie,t as Le,u as Re}from"./pbrDebug-CQsKDg7q.js";import{t as ze}from"./pbrUboDeclaration-oed3_f2e.js";var o=`samplerFragmentAlternateDeclaration`,s=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=s);var c={name:o,shader:s},l=`pbrFragmentSamplersDeclaration`,u=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var d={name:l,shader:u},f=`pbrBlockAlbedoOpacity`,p=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=p);var m={name:f,shader:p},h=`pbrBlockReflectivity`,g=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var Be={name:h,shader:g},_=`pbrBlockAmbientOcclusion`,v=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var Ve={name:_,shader:v},y=`pbrBlockAlphaFresnel`,b=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x={name:y,shader:b},S=`pbrBlockAnisotropic`,C=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=C);var He={name:S,shader:C},w=`pbrBlockReflection`,T=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=T);var Ue={name:w,shader:T},E=`pbrBlockSheen`,D=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=D);var We={name:E,shader:D},O=`pbrBlockClearcoat`,k=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var Ge={name:O,shader:k},A=`pbrBlockIridescence`,j=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var Ke={name:A,shader:j},M=`pbrBlockSubSurface`,N=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var qe={name:M,shader:N},P=`pbrBlockNormalFinal`,F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var Je={name:P,shader:F},I=`pbrBlockLightmapInit`,L=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var Ye={name:I,shader:L},R=`pbrBlockGeometryInfo`,z=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var Xe={name:R,shader:z},B=`pbrBlockReflectance`,V=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var Ze={name:B,shader:V},H=`pbrBlockDirectLighting`,U=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var Qe={name:H,shader:U},W=`pbrBlockFinalLitComponents`,G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var $e={name:W,shader:G},K=`pbrBlockFinalUnlitComponents`,q=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var et={name:K,shader:q},J=`pbrBlockFinalColorComposition`,Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var tt={name:J,shader:Y},X=`pbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var nt={name:X,shader:Z},Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var rt=[ie,ne,r,i,ze,ue,Ae,ce,fe,c,Ce,d,me,t,ye,te,se,de,ke,Re,Me,he,re,Ee,oe,Oe,Ie,Te,Pe,a,De,je,we,_e,ge,pe,be,m,Be,Ve,x,He,Ue,We,Ge,Ke,qe,ee,Fe,ve,Je,ae,Ye,Xe,Ze,Qe,xe,$e,et,tt,Se,n,Ne,nt,le,Le];for(let t of rt)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var it={name:Q,shader:$};export{it as pbrPixelShaderWGSL};