...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var Qe=[i,de,Se,re,p,fe,pe,De,me,Ae,ae,r,ge,a,g,n,t,ve,te,ce,he,u,Me,ke,ie,se,Ee,le,c,Pe,Te,Oe,je,o,Ie,Le,_e,s,Re,ze,be,Ce,Be,ee,Fe,k,Ve,He,we,xe,Ue,We,Ge,Ke,oe,qe,Je,Ye,Xe,ye,ne,Ne,Ze,ue,l];for(let t of Qe)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var $e={name:Q,shader:$};export{$e as openpbrPixelShader};