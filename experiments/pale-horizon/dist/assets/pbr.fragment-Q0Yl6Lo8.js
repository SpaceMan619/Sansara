import{t as e}from"./shaderStore-D-XQlhUT.js";import{n as t,t as ee}from"./clipPlaneFragment-DVK0wgyZ.js";import{n as te,t as ne}from"./fogFragment-CISE_m3s.js";import{a as re,c as ie,i as n,l as ae,n as oe,o as se,r as ce,s as le,t as ue,u as de}from"./oitFragment-CbS3GbFz.js";import{t as fe}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as pe}from"./meshUboDeclaration-BmNu2KU_.js";import{t as me}from"./mainUVVaryingDeclaration-BBamQlxR.js";import{t as he}from"./helperFunctions-BXbvU0Ia.js";import{n as ge,r as _e,t as ve}from"./lightFragment-x7Xpl9uU.js";import{n as ye,t as be}from"./reflectionFunction-CivoLMz9.js";import{n as xe,t as Se}from"./imageProcessingFunctions-kkEl3dsU.js";import{n as Ce,r as we,t as Te}from"./bumpFragment-BtJd9tYZ.js";import{t as Ee}from"./logDepthDeclaration-3gXGtHbI.js";import{t as De}from"./logDepthFragment-C5lxT4l1.js";import{n as Oe,t as ke}from"./pbrIBLFunctions-CSlJv7qb.js";import{t as Ae}from"./pbrBRDFFunctions-BCNINF-p.js";import{t as je}from"./harmonicsFunctions-QSz_WdsQ.js";import{a as Me,c as Ne,d as Pe,i as Fe,l as Ie,n as Le,o as Re,r as ze,s as Be,t as Ve,u as He}from"./pbrDebug-D5jPzGlq.js";import{t as Ue}from"./pbrUboDeclaration--xFZEw0i.js";var r=`pbrFragmentDeclaration`,i=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var We={name:r,shader:i},a=`samplerFragmentAlternateDeclaration`,o=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var Ge={name:a,shader:o},s=`pbrFragmentSamplersDeclaration`,c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var Ke={name:s,shader:c},l=`pbrBlockAlbedoOpacity`,u=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var qe={name:l,shader:u},d=`pbrBlockReflectivity`,f=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var Je={name:d,shader:f},p=`pbrBlockAmbientOcclusion`,m=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var Ye={name:p,shader:m},h=`pbrBlockAlphaFresnel`,g=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _={name:h,shader:g},v=`pbrBlockAnisotropic`,y=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var Xe={name:v,shader:y},b=`pbrBlockReflection`,x=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);var Ze={name:b,shader:x},S=`pbrBlockSheen`,C=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=C);var Qe={name:S,shader:C},w=`pbrBlockClearcoat`,T=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=T);var $e={name:w,shader:T},E=`pbrBlockIridescence`,D=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=D);var et={name:E,shader:D},O=`pbrBlockSubSurface`,k=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var tt={name:O,shader:k},A=`pbrBlockReflectance0`,j=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var nt={name:A,shader:j},M=`pbrClusteredLightingFunctions`,N=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var rt={name:M,shader:N},P=`pbrBlockNormalFinal`,F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var it={name:P,shader:F},I=`pbrBlockLightmapInit`,L=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var at={name:I,shader:L},R=`pbrBlockGeometryInfo`,z=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var ot={name:R,shader:z},B=`pbrBlockReflectance`,V=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var st={name:B,shader:V},H=`pbrBlockDirectLighting`,U=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=U);var ct={name:H,shader:U},W=`pbrBlockFinalLitComponents`,G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var lt={name:W,shader:G},K=`pbrBlockFinalUnlitComponents`,q=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var ut={name:K,shader:q},J=`pbrBlockFinalColorComposition`,Y=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=Y);var dt={name:J,shader:Y},X=`pbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Z);var ft={name:X,shader:Z},Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var pt=[ae,ie,de,We,fe,pe,Ue,me,Pe,le,se,ye,Ge,Oe,Ke,xe,t,Ee,te,ce,he,He,Ie,Ne,Se,n,je,re,Be,Re,Ae,Me,Fe,ke,we,Ce,be,ge,qe,Je,Ye,_,Xe,Ze,Qe,$e,et,tt,_e,nt,rt,ee,ze,Te,it,oe,at,ot,st,ct,ve,lt,ut,dt,De,ne,Le,ft,ue,Ve];for(let t of pt)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var mt={name:Q,shader:$};export{mt as pbrPixelShader};