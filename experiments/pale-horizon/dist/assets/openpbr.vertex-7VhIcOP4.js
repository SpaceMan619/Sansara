import{t as e}from"./shaderStore-D-XQlhUT.js";import{a as t,i as n,n as r,r as i,t as a}from"./bakedVertexAnimation-C6l_KSSy.js";import{n as o,t as s}from"./clipPlaneVertex-C59BO8JS.js";import{n as c,t as l}from"./fogVertex-NHlgMcT2.js";import{t as u}from"./instancesDeclaration-CJBvtBV5.js";import{t as d}from"./vertexColorMixing-DPW6Is9y.js";import{t as f}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as p}from"./meshUboDeclaration-BmNu2KU_.js";import{t as m}from"./mainUVVaryingDeclaration-BBamQlxR.js";import{t as h}from"./helperFunctions-BXbvU0Ia.js";import{t as g}from"./logDepthDeclaration-3gXGtHbI.js";import{a as _,c as v,i as y,l as b,n as x,o as S,r as C,s as w,t as T,u as E}from"./shadowsVertex--0nVb1Fg.js";import{i as D,n as O,r as k,t as A}from"./morphTargetsVertex-6N5r7oF1.js";import{t as j}from"./logDepthVertex-D5IUM6qd.js";import{t as M}from"./pbrBRDFFunctions-BCNINF-p.js";import{t as N}from"./harmonicsFunctions-QSz_WdsQ.js";import{t as P}from"./openpbrUboDeclaration-CbPGRvOI.js";import{t as F}from"./sceneVertexDeclaration-CluTp-RC.js";var I=`openpbrVertexDeclaration`,L=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var R={name:I,shader:L},z=`openpbrNormalMapVertexDeclaration`,B=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V={name:z,shader:B},H=`openpbrNormalMapVertex`,U=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=U);var W={name:H,shader:U},G=`openpbrVertexShader`,K=`#define OPENPBR_VERTEX_SHADER
...
`;e.ShadersStore[G]||(e.ShadersStore[G]=K);var q=[F,E,R,f,p,P,b,m,h,M,t,n,u,v,w,N,V,o,c,S,_,D,k,g,O,A,i,r,a,y,C,x,W,s,l,T,d,j];for(let t of q)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var J={name:G,shader:K};export{J as openpbrVertexShader};