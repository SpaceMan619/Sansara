import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B5VhSG0v.js";import{a as n,c as r,i,l as a,n as o,o as s,r as c,s as l,t as u,u as d}from"./bakedVertexAnimation-BgxOR4Cd.js";import{n as f,t as p}from"./clipPlaneVertex-C59BO8JS.js";import{t as m}from"./bumpVertex-CWhdIpqj.js";import{t as h}from"./harmonicsFunctions-QSz_WdsQ.js";var g=`geometryVertexDeclaration`,_=`uniform mat4 viewProjection;uniform mat4 view;`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var v={name:g,shader:_},y=`geometryUboDeclaration`,b=`#include<sceneUboDeclaration>
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x={name:y,shader:b},S=`geometryVertexShader`,C=`precision highp float;
...
`;e.ShadersStore[S]||(e.ShadersStore[S]=C);var w=[d,a,l,s,r,v,t,x,f,h,n,i,c,o,u,p,m];for(let t of w)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var T={name:S,shader:C};export{T as geometryVertexShader};