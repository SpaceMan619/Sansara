...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var Qe=[te,se,Se,ne,p,ce,le,De,ue,Ae,r,ee,fe,a,g,t,me,ge,ve,ie,de,u,Me,ke,n,re,Ee,ae,c,Pe,Te,Oe,je,o,Ie,Le,pe,s,Re,ze,be,Ce,Be,he,Fe,k,Ve,He,we,xe,Ue,We,Ge,Ke,i,qe,Je,Ye,Xe,_e,ye,Ne,Ze,oe,l];for(let t of Qe)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var $e={name:Q,shader:$};export{$e as openpbrPixelShader};