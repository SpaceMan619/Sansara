import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as n}from"./meshUboDeclaration-BmNu2KU_.js";import{t as r}from"./mainUVVaryingDeclaration-BBamQlxR.js";import{t as i}from"./helperFunctions-BXbvU0Ia.js";import{t as a}from"./logDepthDeclaration-3gXGtHbI.js";import{a as o,c as s,d as c,i as l,l as u,n as d,o as f,r as p,s as m,t as h,u as g}from"./vertexColorMixing-Dr2MLCTE.js";import{a as _,c as v,i as y,l as b,n as x,o as S,r as C,s as w,t as T,u as E}from"./bakedVertexAnimation-BgxOR4Cd.js";import{n as D,t as O}from"./clipPlaneVertex-C59BO8JS.js";import{n as k,r as A,t as j}from"./logDepthVertex-CksyN44U.js";import{t as M}from"./pbrBRDFFunctions-BCNINF-p.js";import{t as N}from"./harmonicsFunctions-QSz_WdsQ.js";import{t as P}from"./openpbrUboDeclaration-CbPGRvOI.js";var F=`sceneVertexDeclaration`,I=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L={name:F,shader:I},R=`openpbrVertexDeclaration`,z=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var B={name:R,shader:z},V=`openpbrNormalMapVertexDeclaration`,H=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U={name:V,shader:H},W=`openpbrNormalMapVertex`,G=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var K={name:W,shader:G},q=`openpbrVertexShader`,J=`#define OPENPBR_VERTEX_SHADER
...
`;e.ShadersStore[q]||(e.ShadersStore[q]=J);var Y=[L,c,B,t,n,P,g,r,i,M,E,b,v,u,s,N,U,D,A,m,f,w,S,a,_,y,C,x,T,o,l,p,K,O,k,d,h,j];for(let t of Y)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var X={name:q,shader:J};export{X as openpbrVertexShader};