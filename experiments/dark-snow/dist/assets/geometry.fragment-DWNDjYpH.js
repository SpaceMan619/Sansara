import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as n}from"./helperFunctions-BXbvU0Ia.js";import{n as r,t as i}from"./reflectionFunction-CivoLMz9.js";import{n as a,r as o,t as s}from"./bumpFragment-BtJd9tYZ.js";import{n as c,t as l}from"./clipPlaneFragment-DVK0wgyZ.js";import{n as u,t as d}from"./pbrIBLFunctions-CSlJv7qb.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./openpbrTransmissionLayerData-CaVCiMki.js";import{t as v}from"./pbrBRDFFunctions-BCNINF-p.js";var y=`mrtFragmentDeclaration`,b=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
layout(location=0) out vec4 glFragData[{X}];
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x={name:y,shader:b},S=`geometryPixelShader`,C=`#extension GL_EXT_draw_buffers : require
...
`;e.ShadersStore[S]||(e.ShadersStore[S]=C);var w=[c,x,o,r,a,n,u,h,t,v,f,d,i,p,g,l,s,m,_];for(let t of w)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var T={name:S,shader:C};export{T as geometryPixelShader};